...
import { Shield, Terminal, Edit, Save, Check, X } from 'lucide-react';
...
export default function PrivacyPage() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await axios.put(`${API}/pages/privacy`, {
        title: editTitle,
    ...
    <div data-testid="privacy-page" className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center gap-2 mb-2 text-[#1793D1] font-mono text-sm">
          ...
          <span className="typing-animation">cat /etc/archhub/privacy.md</span>
        </div>

        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <Shield className="w-6 h-6 text-[#1793D1]" />
            <h1 data-testid="privacy-page-title" className="text-2xl sm:text-3xl font-extrabold tracking-tighter">
              {page?.title || t('privacy_title')}
            </h1>
          </div>
          {isAdmin && !editing && (
            <button
        ...
        {editing ? (
          <div data-testid="privacy-editor" className="space-y-4">
            <input
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                data-testid="privacy-cancel-btn"
